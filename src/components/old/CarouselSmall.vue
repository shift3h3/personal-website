      ...
      <div class="absolute w-full px-5" v-for="(slide, index) in sliders" :key="slide">
        <transition-group name="fade">
          <div
            ...
            class="carousel-content bg-no-repeat bg-center bg-cover rounded-3xl "
            :class="slide.picture"
            style="height:80vh; border-radius:100px;"
          >
            <div class="absolute top-1/2 left-1/2 w-full" style="transform:translate(-50%,-50%)">
              <div class="text-center text-white">
                ...
                <p class="sm:text-xl text-md px-10">
                  {{slide.text}}
                </p>
              </div>
            </div>
          ...
          <div class="w-full" style="height:340px">
            <div class="absolute w-full flex justify-center">
              <div
                ...
                class="w-4 h-4 mx-2 rounded-full bottom-0 cursor-pointer shadow-md z-20 hover:bg-cusblue-500"
              ></div>
            </div>
          </div>
          <!-- END slide indicator buttons -->
          <!-- slide next prev buttons -->
          <div class="absolute text-white  px-10 flex justify-between w-full z-10">
